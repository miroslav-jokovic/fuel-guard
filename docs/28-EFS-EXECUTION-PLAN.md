...
| 3 | Capability architecture | 🔶 *(3.1–3.5 done, plus 3.5b; 3.4 in PR #27, 3.5 on `delivery-p3-pilot-lock`, both unmerged. **Step 3.6 is next.** 3.5a withdrawn — it is Step 4.2)* | `delivery-p3-registry` |
