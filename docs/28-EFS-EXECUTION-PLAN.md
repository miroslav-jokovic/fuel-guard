...
| 3 | Capability architecture | 🔶 *(3.1–3.8 done; 3.8 on `delivery-p3-fitness`. **Steps 3.9 and 3.10 remain**, plus the live QA owed on every migrated capability. 3.5a withdrawn — it is Step 4.2)* | `delivery-p3-registry` |
