...
> **SUPERSEDED 2026-09-24 as the thing sent to counsel.** The memorandum is now
> `COUNSEL-REVIEW-PACKAGE.md`. This file is the working record from 2026-08-23 to 2026-09-15, kept
> unchanged so that section references in the other plans ("§7.2", "§4.1") still resolve. Read it
> for history, never as the current ask.
