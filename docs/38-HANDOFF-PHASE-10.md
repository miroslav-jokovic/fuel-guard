...
| — | §7 Q1/Q2/Q2b/Q2d/Q3/Q4 need WEX; Q2c answered (not this web service). **Q5 added 2026-08-17 and it gates Phase 10's UI** — does a card-level `<limits>` override apply when `limitSource` is `POLICY`? | `docs/37` §7 |
