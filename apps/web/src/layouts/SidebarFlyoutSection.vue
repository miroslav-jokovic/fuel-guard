...
<template>
  <div @mouseenter="openNow" @mouseleave="closeSoon">
    <button
      ...
      :class="sectionActive() ? 'bg-white/10 text-white ring-1 ring-inset ring-white/10 shadow-sm' : 'text-neutral-400 hover:bg-white/[0.07] hover:text-neutral-100'"
    ...
    <Teleport to="body">
      <div
        ...
        class="z-[9999] min-w-56 rounded-xl border border-white/10 bg-neutral-900/90 p-2 shadow-2xl ring-1 ring-black/20 backdrop-blur-2xl supports-[backdrop-filter]:bg-neutral-900/80"
        role="group"
      ...
      >
        ...
        <RouterLink
          ...
          :class="isCurrent(item.to) ? 'bg-white/10 text-white ring-1 ring-inset ring-white/10' : 'text-neutral-300 hover:bg-white/[0.07] hover:text-white'"
