...
/**
 * The one text input. All native attributes (type, placeholder, min, max,
 * step, inputmode, disabled, autocomplete, …) fall through via $attrs.
 * v-model always yields a string, exactly like a bare <input v-model>.
 * text-base on mobile prevents iOS focus-zoom; sm:text-sm from tablet up.
 */
