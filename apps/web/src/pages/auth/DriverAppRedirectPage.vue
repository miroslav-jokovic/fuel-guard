...
<template>
  <div class="text-center">
    <h2 class="text-lg font-semibold text-ink">Use the FuelGuard Driver app</h2>
    <p class="mt-2 text-sm text-ink-muted">
      You're signed in as <span class="font-medium">{{ session.email }}</span
      >. This dashboard is for office staff — drivers log fuel and see their trucks in the
      <span class="font-medium">FuelGuard Driver</span> app on your phone.
    </p>
