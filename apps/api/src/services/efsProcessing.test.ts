...
vi.mock("./scoring/index.js", () => ({ scoreImportWithCascade: mocks.scoreImport }));
vi.mock("./declinedScoring.js", () => ({ scoreDeclinedImport: mocks.scoreDeclined }));
vi.mock("./notify.js", () => ({ notify: mocks.notify }));
