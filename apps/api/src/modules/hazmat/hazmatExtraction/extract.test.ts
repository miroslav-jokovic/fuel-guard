...
describe("computeExtractionFlags — the outcome table (step 6)", () => {
  ...
  it("real engine: extracted gasoline on a non-bulk vehicle → FLAMMABLE, but never auto-clears (eligibility not_checked, D2)", () => {
    const load: LoadInput = {
      ...
      tankState: "loaded",
      lines: [{ hmtRef: "UN1203-gasoline#II", reclassedCombustible: false, isLimitedQuantity: false, quantity: { value: 8000, unit: "gal" }, grossWeightLb: null, compartmentIndex: null, isResidueLine: false, flashPointF: null, ethanolPct: null, packagingKind: "non_bulk", packageCount: null, marinePollutantConcentrationPct: null, marinePollutantPerPackage: null }],
