...
// The delta-feed fetchers moved to their own file with LM4; re-exported here so every existing
// importer keeps one import path for "the Samsara client".
export {
  makeSamsaraStatsFeedFetcher,
  makeSamsaraPositionsFeedFetcher,
  type SamsaraStatsFeedFetcher,
  type SamsaraPositionsFeedFetcher,
} from "./samsaraDeltaFeeds.js";
