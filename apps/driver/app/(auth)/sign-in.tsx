...
import { AppText, Banner, Button, Field, Icon, Input, Screen } from '@/components';
import { AuthMast, AuthTitle } from '@/features/auth/AuthLayout';
...
/**
 * The front door (D-DB15, 2026-09-07): the mark on the navy hero, the form on the cream sheet,
 * every line at the one screen inset. `Screen` owns the keyboard avoidance and the scroll, so the
 * form rides up over the keyboard instead of being squeezed by it.
 */
