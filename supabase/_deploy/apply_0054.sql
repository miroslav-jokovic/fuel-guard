-- ────────────────────────────────────────────────────────────────────
-- MANUAL DEPLOY — 0054 driver_scores (docs/16-DRIVER-PERFORMANCE.md)
-- Copy-paste into the Supabase SQL editor and run. Idempotent.
-- Current/provisional Samsara Safety + Efficiency component scores per driver-week. Member-read; mgr write.
-- ────────────────────────────────────────────────────────────────────
