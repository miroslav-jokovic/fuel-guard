...
const GRANDFATHERED_WRITERS = new Set([
  ...
  "load_events <- apps/api/src/modules/mcleod/tmsLoadIngestWriters.ts",
  "load_stops <- apps/api/src/modules/mcleod/tmsLoadIngestWriters.ts",
  "loads <- apps/api/src/modules/mcleod/tmsLoadIngestWriters.ts",
